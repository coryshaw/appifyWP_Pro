...
define( 'NOTIFIER_THEME_NAME', 'AppifyWP Pro' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'appifyWP_Pro' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://appifywp.com/notifier_appifyWP-pro.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function update_notifier() { 
	...
	<div class="wrap">
		...
		<div id="instructions">
		    ...
		    <p>To update the Theme, login to <a href="http://appifywp.com">AppifyWP.com</a>, head over to your <strong>downloads</strong> section and re-download the theme like you did when you bought it.</p>
