...
<div class="app-nav">
  ...
  <?php while ( $loop->have_posts() ) : $loop->the_post(); 
    ...
    ?>
    <a class="<?php the_slug(); ?><?php if ($navLoopCount == 0){?> current<?php } ?> showtooltip" href="#<?php the_slug(); ?>" title="<?php the_title(); ?>">
    <?php if( $app_icon != '' ): ?>
    <img class="app-icon" src="<?php echo $app_icon; ?>" alt="<?php the_title(); ?> icon" />
    <?php endif; ?>
    <?php $navLoopCount++ ?>
  <?php endwhile; ?>
  </a>
  		    	...
  		    	<div class="showcase-background <?php echo $appearance_background_image ?>" style="<?php if($appearance_background_image == 'custom' && $appearance_custom_background_image != ''): ?>background-image: url(<?php echo $appearance_custom_background_image ?>);<?php endif; ?><?php if($appearance_background_color != ''){echo 'background-color:'.$appearance_background_color.';';}?>"></div>
  		       		...
  		       		<?php endif; ?>
  			        	...
  			        	<?php if ($platformCount != 0){	
  		                	include 'platforms/platform_loop_home_carosel.php';
  		                } else {
				...
				<div class="row">
					<div class="span12 content current">
						...
						<section>
							...
							<div class="alert">This guide will show until you've added your first app, and will be replaced with your apps. Additionally, you can change this default homepage to a page, post, or a blog in AppifyWP Settings > Homepage</div>
						</section>
...
<?php if ($loop->have_posts()): 
	include 'includes/home_carousel_js.php'; 
	endif;
?>
<?php get_footer(); ?>